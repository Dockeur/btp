...
import {
  ...
  SubMenuInvestir,
  SubMenuAide,
} from "../../components/SousMenu/SubMenu";
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
          ...
          <button
            onClick={closeMenu}
            className="p-2 text-texteCouleur hover:text-Cprimary hover:bg-neutralSilver rounded-lg transition-all duration-200"
          >
            <FaXmark className="h-5 w-5" />
          </button>
        </div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <svg
                        className={`w-4 h-4 transition-transform duration-200 ${
                          subMenuVisible === index ? "rotate-180" : ""
                        }`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                    ...
                    <div
                      className={`overflow-hidden transition-all duration-300 ${
                        subMenuVisible === index ? "max-h-96 mt-1" : "max-h-0"
                      }`}
                    >
