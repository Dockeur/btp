    ...
    return (
      <>
        <div className="p-6 text-justify lg:text-base text-sm ">
          <h2 className="text-center font-semibold text-Csecondary1 underline">Proposez votre Appartement</h2>
...
export default AppartmentPorpose;
