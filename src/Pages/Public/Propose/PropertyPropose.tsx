    ...
    <>
      <div className="p-6 text-justify lg:text-base text-sm ">
        <h2 className="text-center lg:text-2xl p-2  font-semibold text-Csecondary1 underline">
          Proposez votre Propriété immobilier
        </h2>
        <p className="text-center">
          Pour soumettre votre Propriété immobilier (immeuble,duplex, villa,
          Appartement), veuillez remplir le formulaire suivant :
        </p>
      </div>
...
export default PropertyPropose;
