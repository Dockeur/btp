...
// import Index from "./Pages/Public/Proposer/Index.tsx";
    ...
    <>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route
            path="/immeubles/:id"
            element={<Layout><BuildingDetailsPage /></Layout>}
          />
          {/* <Route path={routes.aide.path} element={<Layout><Aide /></Layout>} /> */}
          ...
          <Route path="/Admin/LandCustomerSale" element={
            <ProtectedRoute>
              <AdminLayout><AdminSaleRequestsPage /></AdminLayout>
            </ProtectedRoute>
          } />
          <Route path="/admin/Contracts" element={
            <ProtectedRoute>
              <AdminLayout><AdminContractsPage /></AdminLayout>
            </ProtectedRoute>
          } />
          ...
          <Route path={routes.admin.employees.path} element={
            <ProtectedRoute>
              <AdminLayout><Employee /></AdminLayout>
            </ProtectedRoute>
          } />
          <Route path="admin/appointment" element={
            <ProtectedRoute>
              <AdminLayout><AdminAppointmentsTable /></AdminLayout>
            </ProtectedRoute>
          } />
          <Route path={routes.admin.customers.path} element={
            <ProtectedRoute>
              <AdminLayout><Customer /></AdminLayout>
            </ProtectedRoute>
          } />
          <Route path={routes.admin.employees.path + "/:id"} element={
            <ProtectedRoute>
              <AdminLayout><ShowEmployee /></AdminLayout>
            </ProtectedRoute>
          } />
          <Route path={routes.admin.customers.path + "/:id"} element={
            <ProtectedRoute>
              <AdminLayout><ShowCustomer /></AdminLayout>
            </ProtectedRoute>
          } />
          ...
          <Route path={routes.admin.lands.path + "/:id"} element={
            <ProtectedRoute>
              <AdminLayout><ShowLand /></AdminLayout>
            </ProtectedRoute>
          } />
