...
export const getColumns = ({
    ...
    options
        ...
        {
            title: <HeaderCell title="Bien" sortable
        ...
        {
            title: <HeaderCell title="À vendre" sortable className="whitespace-nowrap"
            ...
            render: (for_sale: any) => (
                <div className="whitespace-nowrap">
                    {for_sale ? <FiCheckCircle className='text-green text-xl' /> : <RiCheckboxBlankCircleLine className='text-red text-2xl' />}
                </div>
            ),
        },
        {
            title: <HeaderCell title="À louer" sortable className="whitespace-nowrap"
            ...
            render: (for_rent: any) => (
                <div className="whitespace-nowrap">
                    {for_rent ? <FiCheckCircle className='text-green text-xl' /> : <RiCheckboxBlankCircleLine className='text-red text-2xl' />}
                </div>
            ),
        },
        {
            title: <HeaderCell title="Publié le" sortable className="whitespace-nowrap"
