...
export const navItems = [
    ...
    },
    {
        ...
        subs: [
            { title: "Employés",  url: "/admin/employees" },
    ...
    },
    {
        ...
        subs: [
            { title: "Logements",   url: "/admin/accommodations" },
            { title: "Propriétés",  url: "/admin/properties" },
            { title: "Terrains",    url: "/admin/lands" },
        ]
    },
    {
        title: "Ventes",
        ...
        subs: [
            ...
            { title: "Commandes",         url: "/admin/orders" },
            { title: "Produits Client",   url: "/Admin/LandCustomerSale" },
            { title: "Commandes Clients", url: "/admin/order-customers" },
        ]
    },
    {
        title: "Appointment",
